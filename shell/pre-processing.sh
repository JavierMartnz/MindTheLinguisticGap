...
python3 ./src/extract_isolated_videos_cngt.py --root=/vol/tensusers5/jmartinez/datasets --cngt_folder=CNGT_512 --cngt_output_folder=cngt_single_signs_512 --signbank_vocab_file=signbank_vocab.gzip --window_size=16
deactivate
