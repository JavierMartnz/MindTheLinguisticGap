...
import shutil
import cv2
from utils.util import load_gzip, save_gzip, make_dir
...
def main(params):
            ...
            if glosses_righth:
                ...
                for ann in glosses_righth:
                    ...
                    if parsed_gloss in signbank_vocab['gloss_to_id']:
                        ...
                        cngt_id_to_gloss[signbank_vocab['gloss_to_id'][parsed_gloss]] = parsed_gloss
    ...
    cngt_vocab = {'gloss_to_id': cngt_gloss_to_id, 'id_to_gloss': cngt_id_to_gloss}
    save_gzip(cngt_vocab, cngt_vocab_path)

    print(f"Copying video and annotation files to new folder {cngt_output_root}")

    os.makedirs(cngt_output_root, exist_ok=True)

    # we take the gloss files since they're already filtered
