...
class Unit3D(nn.Module):
    ...
    def __init__(self, in_channels,
        ...
        self.conv3d = nn.Conv3d(
            ...
            stride=self._stride,
            padding=0,  # padding 0 here. We will dynamically pad based on input size in forward function
            bias=self._use_bias
        )
...
class InceptionI3d(nn.Module):
    ...
    def __init__(self,
        ...
        self.end_points[end_point] = self.softmax
