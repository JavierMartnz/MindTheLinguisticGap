...
def get_gloss_freq(glosses_righth, glosses_lefth, sb_vocab, gloss_count_dict):
...
def main(params):
    ...
    for ann_file in tqdm(ann_filenames):
        ...
        gloss_count_dict = get_gloss_freq(s1_glosses_righth, s1_glosses_lefth, sb_vocab, gloss_count_dict)
        gloss_count_dict = get_gloss_freq(s2_glosses_righth, s2_glosses_lefth, sb_vocab, gloss_count_dict)
